package com.rabt.healthycollection.base.widget;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        tabMenuView.setPadding(0, dpTpPx(2), 0, dpTpPx(2));
    ...
    public void setMenuBackground(int color) {
        tabMenuView.setBackgroundColor(ContextCompat.getColor(context, color));
    }
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        if (i < tabTexts.size() - 1) {
            ...
            params.setMargins(0, dpTpPx(6), 0, dpTpPx(6));
